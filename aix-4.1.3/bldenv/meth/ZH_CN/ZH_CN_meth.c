static char sccsid[] = "@(#)74	1.1  src/bldenv/meth/ZH_CN/ZH_CN_meth.c, ils-zh_CN, bos41B, 9504A 12/16/94 16:53:15";
/*
...
extern __mbstopcs_utf8cn(); 
extern __mbtopc_utf8cn(); 
extern __pcstombs_utf8cn(); 
extern __pctomb_utf8cn(); 
extern __csid_std(); 
extern __charmap_init(); 
extern __mblen_utf8cn(); 
extern __mbstowcs_utf8cn(); 
extern __mbtowc_utf8cn(); 
extern nl_csinfo(); 
extern __wcsid_std(); 
extern __wcstombs_utf8cn(); 
extern __wcswidth_utf8cn(); 
extern __wctomb_utf8cn(); 
extern __wcwidth_utf8cn(); 
...
{"charmap.__mbstopcs",
  {0, 0, 0, "__mbstopcs_utf8cn"},
  {0, 0, 0, "ZH_CN.o"},
  {-1, -1, -1, 0}},
{"charmap.__mbtopc",
  {0, 0, 0, "__mbtopc_utf8cn"},
  {0, 0, 0, "ZH_CN.o"},
  {-1, -1, -1, 1}},
{"charmap.__pcstombs",
  {0, 0, 0, "__pcstombs_utf8cn"},
  {0, 0, 0, "ZH_CN.o"},
  {-1, -1, -1, 2}},
{"charmap.__pctomb",
  {0, 0, 0, "__pctomb_utf8cn"},
  {0, 0, 0, "ZH_CN.o"},
  {-1, -1, -1, 3}},
{"charmap.csid",
  {0, 0, 0, "__csid_std"},
...
{"charmap.init",
  ...
  {-1, -1, -1, 5}},
{"charmap.mblen",
  {0, 0, 0, "__mblen_utf8cn"},
  {0, 0, 0, "ZH_CN.o"},
  {-1, -1, -1, 6}},
{"charmap.mbstowcs",
  {0, 0, 0, "__mbstowcs_utf8cn"},
  {0, 0, 0, "ZH_CN.o"},
  {-1, -1, -1, 7}},
{"charmap.mbtowc",
  {0, 0, 0, "__mbtowc_utf8cn"},
  {0, 0, 0, "ZH_CN.o"},
  {-1, -1, -1, 8}},
{"charmap.nl_langinfo",
  {0, 0, 0, "nl_csinfo"},
...
{"charmap.wcsid",
  ...
  {-1, -1, -1, 10}},
{"charmap.wcstombs",
  {0, 0, 0, "__wcstombs_utf8cn"},
  {0, 0, 0, "ZH_CN.o"},
  {-1, -1, -1, 11}},
{"charmap.wcswidth",
  {0, 0, 0, "__wcswidth_utf8cn"},
  {0, 0, 0, "ZH_CN.o"},
  {-1, -1, -1, 12}},
{"charmap.wctomb",
  {0, 0, 0, "__wctomb_utf8cn"},
  {0, 0, 0, "ZH_CN.o"},
  {-1, -1, -1, 13}},
{"charmap.wcwidth",
  {0, 0, 0, "__wcwidth_utf8cn"},
  {0, 0, 0, "ZH_CN.o"},
  {-1, -1, -1, 14}},
{"collate.fnmatch",
  {0, 0, 0, "__fnmatch_std"},
