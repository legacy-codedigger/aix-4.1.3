static char sccsid[] = "@(#)71  1.1  src/bos/usr/lib/nls/loc/swkbd/Es_LA.c, lftdd, bos41J, 9520A_all 5/10/95 14:09:37";
/*
...
{graphic,norm,0,p0,IC_OR},     /* pipe symbol                        pos 1   */
...
{graphic,norm,0,p0,IC_INVQUES},/* inverted ?                         pos 13  */
...
{graphic,dead,0,p0,IC_ACUTE},  /* acute accent                       pos 27  */
{graphic,norm,0,p0,IC_PLUS},   /* +                                  pos 28  */
...
{graphic,norm,0,p0,IC_LCNTIL}, /* n tilde small                      pos 40  */
{graphic,norm,0,p0,IC_LBRACE}, /* left brace                         pos 41  */
...
{graphic,norm,0,p0,IC_AST},    /* Asterisk                      pos 100 */
...
{graphic,norm,0,p0,IC_DEGREE}, /* degree symbol                      pos 1   */
...
{graphic,norm,0,p0,IC_INVEXCL},/* inverted !                         pos 13  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 14  */
...
{graphic,dead,0,p0,IC_UMLAUT}, /* diaeresis                          pos 27  */
{graphic,norm,0,p0,IC_AST},    /* *                                  pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{graphic,norm,0,p0,IC_UCNTIL}, /* N tilde capital                    pos 40  */
{graphic,norm,0,p0,IC_LSB},    /* left bracket                       pos 41  */
...
{sgl_ctl,norm,0, 0,IC_ESC},    /* Escape                            pos 27  */
...
{sgl_ctl,cpfk,0, 0,IC_SS1},    /* single shift                      pos 55  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift key; do not alter     pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter         pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 59  */
...
{graphic,norm,0,p0,IC_NOTSIGN},/* notsign                            pos 1   */
...
{graphic,dead,0,p0,IC_APPROX}, /* tilde                              pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not avail on WT KBD                pos 29  */
{es_func,norm,0, 1,KF_IGNORE}, /* caps Lock key; do not alter        pos 30  */
...
{graphic,dead,0,p0,IC_AND},    /* circumflex                         pos 41  */
{graphic,dead,0,p0,0x60},      /* grave accent                       pos 42  */
...
main ()
{
    ...
    fd = open("Es_LA.IBM-850.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&spanish_key_map,sizeof(lft_swkbd_t));
