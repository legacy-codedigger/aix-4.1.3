static char sccsid[] = "@(#)60  1.2  src/bos/usr/lib/nls/loc/swkbd/ZH_CN.c, ils-zh_CN, bos41J, 9514A_all 4/3/95 14:02:35";
/*
...
main ()
{
    ...
    fd = open("ZH_CN.UTF-8.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
