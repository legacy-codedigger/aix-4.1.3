static char sccsid[] = "@(#)99	1.1  src/bos/usr/lib/nls/loc/swkbd/Ja_JP@alt.c, lftdd, bos411, 9434B411a 8/25/94 03:37:19";
/*
...
{ctlfunc,stat,0, 1,KF_ALN},    /* alphanum shift                    pos 30  */
...
{ctlfunc,stat,0, 1,KF_KAT},    /* katakana shift                      pos 133 */
           },
...
{ctlfunc,stat,0, 1,KF_CMDSW},  /* Conversion mode switch             pos 14  */
...
{ctlfunc,stat,0, 1,KF_KNO},    /* Kanji No.                          pos 30  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 29  */
{ctlfunc,stat,0, 1,KF_ALN},    /* alpha num shift               pos 30  */
...
main ()
{
    ...
    fd = open("Ja_JP.IBM-932@alt.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
