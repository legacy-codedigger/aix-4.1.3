static char sccsid[] = "@(#)06  1.19  src/bos/usr/lib/nls/loc/swkbd/Ja_JP.c, lftdd, bos411, 9428A410j 3/23/94 13:51:31";
/*
...
{graphic,norm,0,p0,0x5c},      /* Yen Symbol                        pos 14  */
...
{ctlfunc,stat,0, 1,KF_KAT},    /* katakana shift                    pos 30  */
...
{ctlfunc,stat,0, 1,KF_ALN},    /* alphanum shift                    pos 60  */
...
{graphic,norm,0,p0,IC_ULCORN},  /* upper Left corner {box)       pos 91  */
{graphic,norm,0,p0,IC_RARM},    /* Right Arm {box)               pos 92  */
{graphic,norm,0,p0,IC_LLCORN},  /* Lower Left corner {box)       pos 93  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                 pos 94  */
{graphic,norm,0,p0,IC_SLASH},   /* slash                         pos 95  */
{graphic,norm,0,p0,IC_TEE},     /* Tee {box)                     pos 96  */
{graphic,norm,0,p0,IC_CROSS},   /* cross {box)                   pos 97  */
{graphic,norm,0,p0,IC_INVTEE},  /* Inverted Tee {box)            pos 98  */
{graphic,norm,0,p0,IC_VERTBAR}, /* Vertical Bar {box)            pos 99  */
{graphic,norm,0,p0,IC_COM},     /* ,                             pos 100 */
{graphic,norm,0,p0,IC_URCORN},  /* upper Right corner {box)      pos 101 */
{graphic,norm,0,p0,IC_LARM},    /* Left Arm {box)                pos 102 */
{graphic,norm,0,p0,IC_LRCORN},  /* Lower Right corner {box)      pos 103 */
{graphic,norm,0,p0,IC_HORZBAR}, /* Horizontal Bar {box)          pos 104 */
...
{ctlfunc,stat,0, 1,KF_NOC},     /* no kkc (no convert)           pos 131 */
{ctlfunc,stat,0, 1,KF_CNV},     /* kkc (convert)                 pos 132 */
{ctlfunc,stat,0, 1,KF_HIR},     /* hiragana shift                pos 133 */
           },
...
{graphic,norm,0,p0,IC_APPROX}, /* tilde                              pos 11  */
{graphic,norm,0,p0,IC_EQ},     /* equals                             pos 12  */
{graphic,norm,0,p0,0x7e},      /* overbar                            pos 13  */
{graphic,norm,0,p0,0x7c},      /* pipe symbol                        pos 14  */
...
{graphic,norm,0,p0,IC__},      /* _                                  pos 56  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not available                       pos 130 */
{ctlfunc,stat,0, 1,KF_NOC},    /* no kkc {no convert)                 pos 131 */
{ctlfunc,stat,0, 1,KF_PRVCD},  /* previous candidate                  pos 132 */
{ctlfunc,stat,0, 1,KF_HIR},    /* hiragana shift                      pos 133 */
           },
...
{ctlfunc,norm,0, 0,KF_PF57},   /* PFK 57                            pos 14  */
...
{ctlfunc,norm,0, 0,KF_PF115},  /* PFK 115                           pos 27  */
{sgl_ctl,norm,0, 0,IC_ESC},    /* Escape                            pos 28  */
{es_func,norm,0, 0,IC_IGNORE}, /* not available                     pos 29  */
{ctlfunc,stat,0, 1,KF_RSV4},   /* KKC reserved                      pos 30  */
...
{sgl_ctl,norm,0, 0,IC_CR},     /* line feed                         pos 52  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter         pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 59  */
{ctlfunc,stat,0, 1,KF_RSV5},   /* KKC reserved #5                   pos 60  */
{graphic,norm,0,p0,IC_SP},     /* Space Bar                         pos 61  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Alternate key; do not alter pos 62  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                     pos 63  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 129 */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 130 */
{ctlfunc,stat,0, 1,KF_DGNSS},  /* KKC diagnosis                 pos 131 */
{ctlfunc,stat,0, 1,KF_RSV7},   /* KKC reserved #7               pos 132 */
{ctlfunc,stat,0, 1,KF_RSV8},   /* KKC reserved #8               pos 133 */
           },
...
{ctlfunc,stat,0, 1,KF_KNO},    /* Kanji No.                          pos 14  */
...
{ctlfunc,stat,0, 1,KF_CMDSW},  /* Conversion mode switch             pos 30  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 129 */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 130 */
{ctlfunc,stat,0, 1,KF_RSV6},   /* KKC reserved #6               pos 131 */
{ctlfunc,stat,0, 1,KF_ACD},    /* all candidates shift          pos 132 */
{ctlfunc,stat,0, 1,KF_RKC},    /* RKC                           pos 133 */
           },
...
{ctlfunc,stat,0, 1,KF_RKC},    /* rkc                           pos 133 */
           ...
           {
/* KATAKANA BASE KEY ASSIGNMENTS   ------Main key bank     */
{es_func,norm,0, 1,KF_IGNORE}, /* ignore, not on keyboard       pos 0   */
{ctlfunc,stat,0, 1,KF_RSV1},   /* KKC reserved #1,              pos 1   */
{graphic,norm,0,p0,IC_KNU},    /* nu                            pos 2   */
{graphic,norm,0,p0,IC_KFU},    /* fu                            pos 3   */
{graphic,norm,0,p0,IC_KA},     /* a                             pos 4   */
{graphic,norm,0,p0,IC_KU},     /* u                             pos 5   */
{graphic,norm,0,p0,IC_KE},     /* e                             pos 6   */
{graphic,norm,0,p0,IC_KO},     /* o                             pos 7   */
{graphic,norm,0,p0,IC_KYA},    /* ya                            pos 8   */
{graphic,norm,0,p0,IC_KYU},    /* yu                            pos 9   */
{graphic,norm,0,p0,IC_KYO},    /* yo                            pos 10  */
{graphic,norm,0,p0,IC_KWA},    /* wa                            pos 11  */
{graphic,norm,0,p0,IC_KHO},    /* ho                            pos 12  */
{graphic,norm,0,p0,IC_KHE},    /* he                            pos 13  */
{graphic,norm,0,p0,IC_CHONKGO},/* choon kigo                    pos 14  */
{sgl_ctl,curs,0, 0,IC_BS},     /* Backspace                     pos 15  */
{sgl_ctl,curs,0, 0,IC_HT},     /* horizontal tab                pos 16  */
{graphic,norm,0,p0,IC_KTA},    /* ta                            pos 17  */
{graphic,norm,0,p0,IC_KTE},    /* te                            pos 18  */
{graphic,norm,0,p0,IC_KI},     /* i                             pos 19  */
{graphic,norm,0,p0,IC_KSU},    /* su                            pos 20  */
{graphic,norm,0,p0,IC_KKA},    /* ka                            pos 21  */
{graphic,norm,0,p0,IC_KN},     /* kn                            pos 22  */
{graphic,norm,0,p0,IC_KNA},    /* na                            pos 23  */
{graphic,norm,0,p0,IC_KNI},    /* ni                            pos 24  */
{graphic,norm,0,p0,IC_KRA},    /* ra                            pos 25  */
{graphic,norm,0,p0,IC_KSE},    /* se                            pos 26  */
{graphic,norm,0,p0,IC_DAKUTEN},/* dakuten                       pos 27  */
{graphic,norm,0,p0,IC_HANDAKU},/* handakuten                    pos 28  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 29  */
{ctlfunc,stat,0, 1,KF_KAT},    /* katakana shift                pos 30  */
{graphic,norm,0,p0,IC_KTI},    /* ti                            pos 31  */
{graphic,norm,0,p0,IC_KTO},    /* to                            pos 32  */
{graphic,norm,0,p0,IC_KASI},   /* si                            pos 33  */
{graphic,norm,0,p0,IC_KHA},    /* ha                            pos 34  */
{graphic,norm,0,p0,IC_KKI},    /* ki                            pos 35  */
{graphic,norm,0,p0,IC_KKU},    /* ku                            pos 36  */
{graphic,norm,0,p0,IC_KMA},    /* ma                            pos 37  */
{graphic,norm,0,p0,IC_KNO},    /* no                            pos 38  */
{graphic,norm,0,p0,IC_KRI},    /* ri                            pos 39  */
{graphic,norm,0,p0,IC_KRE},    /* re                            pos 40  */
{graphic,norm,0,p0,IC_KKE},    /* ke                            pos 41  */
{graphic,norm,0,p0,IC_KMU},    /* mu                            pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},     /* line feed                     pos 43  */
{es_func,norm,0, 1,KF_IGNORE}, /* Left Shift Key; do not alter  pos 44  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 45  */
{graphic,norm,0,p0,IC_KTU},    /* tu                            pos 46  */
{graphic,norm,0,p0,IC_KSA},    /* sa                            pos 47  */
{graphic,norm,0,p0,IC_KSO},    /* so                            pos 48  */
{graphic,norm,0,p0,IC_KHI},    /* hi                            pos 49  */
{graphic,norm,0,p0,IC_KKO},    /* ko                            pos 50  */
{graphic,norm,0,p0,IC_KMI},    /* mi                            pos 51  */
{graphic,norm,0,p0,IC_KMO},    /* mo                            pos 52  */
{graphic,norm,0,p0,IC_KNE},    /* ne                            pos 53  */
{graphic,norm,0,p0,IC_KRU},    /* ru                            pos 54  */
{graphic,norm,0,p0,IC_KME},    /* me                            pos 55  */
{es_func,norm,0,p0,IC_KRO},    /* ro                            pos 56  */
{es_func,norm,0, 1,KF_IGNORE}, /* Right Shift; do not alter     pos 57  */
{es_func,norm,0, 1,KF_IGNORE}, /* control key; do not alter     pos 58  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 59  */
{ctlfunc,stat,0, 1,KF_ALN},    /* alpha num shift               pos 60  */
{graphic,norm,0,p0,IC_SP},     /* space bar                     pos 61  */
{es_func,norm,0, 1,KF_IGNORE}, /* Alternate shift               pos 62  */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 63  */
{ctlfunc,cpfk,0, 0,KF_PF114},  /* PFK 114                       pos 64  */
     /* BASE KEY ASSIGNMENTS  ----  Function keys bank  */
{es_func,norm,0,1,KF_IGNORE}, /* not available                 pos 65  */
...
{ctlfunc,curs,0,1,KF_CUF},    /* cursor forward                     pos 89  */
     /* BASE KEY ASSIGNMENTS  ----  Numeric keypad bank  */
{es_func,norm,0, 1,KF_IGNORE}, /* Num Lock key; do not alter         pos 90  */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 91  */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 92  */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 93  */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 94  */
{graphic,norm,0,p0,IC_SLASH},  /* /                                  pos 95  */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 96  */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 97  */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 98  */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 99  */
{graphic,norm,0,p0,IC_COM},    /* comma                              pos 100 */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 101 */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 102 */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 103 */
{es_func,norm,0, 1,KF_IGNORE}, /* not assigned                       pos 104 */
{graphic,norm,0,p0,IC_DASH},   /* -                                  pos 105 */
{graphic,norm,0,p0,IC_AST},    /* *                                  pos 106 */
{es_func,norm,0, 1,KF_IGNORE}, /* not available                      pos 107 */
{sgl_ctl,norm,0, 0,IC_CR},     /* carriage Return                    pos 108 */
...
{ctlfunc,stat,0, 1,KF_NOC},    /* no kkc {no convert)                pos 131 */
{ctlfunc,stat,0, 1,KF_CNV},    /* kkc {convert)                      pos 132 */
{ctlfunc,stat,0, 1,KF_HIR},    /* hiragana                           pos 133 */
           },
           ...
           {
/* KATAKANA SHIFT KEY ASSIGNMENTS ---- Main key bank   */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore, not on keyboard            pos 0   */
{ctlfunc,stat,0, 1,KF_IGNORE},  /* KKC reserved #2                    pos 1   */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore                             pos 2   */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore                             pos 3   */
{graphic,norm,0,p0,IC_SKA},     /* small katakana a                   pos 4   */
{graphic,norm,0,p0,IC_SKU},     /* small katakana u                   pos 5   */
{graphic,norm,0,p0,IC_SKE},     /* small katakana e                   pos 6   */
{graphic,norm,0,p0,IC_SKO},     /* small katakana o                   pos 7   */
{graphic,norm,0,p0,IC_SKYA},    /* small katakana ya                  pos 8   */
{graphic,norm,0,p0,IC_SKYU},    /* small katakana yu                  pos 9   */
{graphic,norm,0,p0,IC_SKYO},    /* small katakana yo                  pos 10  */
{graphic,norm,0,p0,IC_KWO},     /* katakana wo                        pos 11  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore                             pos 12  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore                             pos 13  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore                             pos 14  */
{sgl_ctl,curs,0, 0,IC_BS},      /* Backspace                          pos 15  */
{ctlfunc,curs,0, 1,KF_CBT},     /* cursor back tab                    pos 16  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore                             pos 17  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore                             pos 18  */
{graphic,norm,0,p0,IC_SKI},     /* small katakana i                   pos 19  */
...
{graphic,norm,0,p0,IC_HAJKKK},  /* hajime kagi kakko                  pos 28  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore                             pos 29  */
{ctlfunc,stat,0, 1,KF_KAT},     /* katakana shift                     pos 30  */
...
{graphic,norm,0,p0,IC_OWAKKK},  /* owari kagi kakko                   pos 42  */
{sgl_ctl,norm,0, 0,IC_CR},      /* line feed                          pos 43  */
{es_func,norm,0, 1,KF_IGNORE},  /* Left Shift Key; do not alter       pos 44  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 45  */
{graphic,norm,0,p0,IC_SKTU},    /* small katakana tu                  pos 46  */
...
{graphic,norm,0,p0,IC_TOUTEN},  /* touten                             pos 53  */
{graphic,norm,0,p0,IC_KUTEN},   /* kuten                              pos 54  */
{graphic,norm,0,p0,IC_CHUUTN},  /* chuuten                            pos 55  */
{es_func,norm,0, 1,KF_IGNORE},  /* ignore                             pos 56  */
{es_func,norm,0, 1,KF_IGNORE},  /* Right Shift; do not alter          pos 57  */
{es_func,norm,0, 1,KF_IGNORE},  /* control key; do not alter          pos 58  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 59  */
{ctlfunc,stat,0, 1,KF_ALN},     /* alpha num shift                    pos 60  */
...
{es_func,norm,0, 1,KF_IGNORE},  /* Right Alternate key; do not alter  pos 62  */
{es_func,norm,0, 1,KF_IGNORE},  /* not available                      pos 63  */
{es_func,norm,0, 1,KF_IGNORE},  /* VTRM previous window               pos 64  */
      /* BASE KEY ASSIGNMENTS  ----  Function keys bank  */
{es_func,norm,0,1,KF_IGNORE}, /* not available                 pos 65  */
{es_func,norm,0,1,KF_IGNORE}, /* not available                 pos 66  */
{es_func,norm,0,1,KF_IGNORE}, /* not available                 pos 67  */
...
{es_func,norm,0, 1,KF_IGNORE}, /* not available                 pos 130 */
{ctlfunc,stat,0, 1,KF_NOC},    /* no kkc {no convert)           pos 131 */
{ctlfunc,norm,0, 1,KF_PRVCD},  /* previous candidate            pos 132 */
{ctlfunc,stat,0, 1,KF_HIR},    /* hiragana shift                pos 133 */
           },
...
main ()
{
    ...
    fd = open("Ja_JP.IBM-932.lftkeymap",O_CREAT|O_RDWR, 0777);
    if (fd == -1) {
    ...
    rc = write(fd,&japanese_key_map,sizeof(lft_swkbd_t));
